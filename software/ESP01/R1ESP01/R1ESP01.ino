/*
 ULTIMO DEL DIA  28/04
*/
String W =" ";
char w =' ';
int robot = 1;//numero de robot
...
IPAddress ip(192, 168, 1, 101); // IP ROBOT
...
void reconnect() {
  while (!client.connected()) {
    if (client.connect("ROBOT1")) {
      client.publish("control", "robot1,enlinea,,");
      client.subscribe("campo/desplazamiento/robot1");
    } else {
      delay(1000);
    }
  }
